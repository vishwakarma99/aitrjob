            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Edit Job Salary</h2>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-16 col-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="needs-validation" method="post" action="{{ URL::to('admin/jobsalary/update/'.$jobsalary->id) }}" novalidate>
                                        @csrf
                                        <div class="row">
                                            <div class="col-xl-12 col-md-12 col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="text" class="form-control" name="job_min_salary" id="job_min_salary"
                                                        value="{{$jobsalary->job_min_salary}}" placeholder="Enter Min Salary">
                                            ...
                                            <div class="col-xl-12 col-md-12 col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="text" class="form-control" name="job_max_salary" id="job_max_salary"
                                                        value="{{$jobsalary->job_max_salary}}" placeholder="Enter Min Salary">
