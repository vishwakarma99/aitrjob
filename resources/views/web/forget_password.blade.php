				...
				<div class="row">
					<div class="col-md-12 m-b30">
						<div class="p-a30 job-bx max-w500 radius-sm bg-white m-auto" style="text-align: right;">
							<a class="text-right text-dark" href="javascript: history.go(-1)">X <i class="fa fa-chevron"></i></a>
							<div class="tab-content">
								<form class="tab-pane active" id="emailLoginForm" method="post">
									...
									<h3 class="m-b10 text-center">Forget Password</h3>
									...
									<div class="text-center">
										<button type="button" id="forgetPassword" class="site-button">Send Reset Link</button>
									</div>
	...
	<script>
		...
		$('#forgetPassword').click(function(event){
            ...
            .sendPasswordResetEmail(emailAddress)
              .then((result) => {
                  $('#email_error').html('Password reset link send to your email');    
              })
              .catch((error) => {
                if(errorCode == 'auth/user-not-found'){
                    $('#email_error').html('User not found with this email');    
                }else{
