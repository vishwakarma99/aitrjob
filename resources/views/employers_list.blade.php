                                                ...
                                                <table class="table table-borderless" id="myTable">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{$user->contact_person_designation}}</td>
                                                            ...
                                                            <td> 
                                                                <a style="color: white;" style="margin: 2px;" href="{{ URL::to('admin/viewEmployerJobs/'.$user->uid) }}" class="btn btn-primary">Jobs</a>
                                                            </td>

                                                            <td> 
                                                                <a style="color: white;" style="margin: 2px;" href="{{ URL::to('admin/viewEmployerProfile/'.$user->uid) }}" class="btn btn-primary">View</a>
                                                            </td>

                                                            <td style="display: flex;">
                                                                @if ($user->user_status == 1)
                                                                    <a style="color: white;" style="margin: 2px;" href="{{ URL::to('admin/employerStatus/'.$user->user_id.'/'.$user->user_status) }}" class="btn btn-success">Block</a>
                                                                @else
                                                                    <a style="color: white;" style="margin: 2px;" href="{{ URL::to('admin/employerStatus/'.$user->user_id.'/'.$user->user_status) }}" class="btn btn-danger">UnBlock</a>
                                                                @endif
